<x-app-layout>
    <div class="flex py-12 h-screen">
        ...
        <div class="flex-1 px-6 sm:px-12">
            <div class="mx-auto bg-[#102A45] text-white w-full p-8 rounded-lg shadow-lg">
                ...
                <form id="requirementsForm" method="POST" enctype="multipart/form-data" action="{{ route('dashboard') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            class="block w-full mt-2 rounded-lg border-gray-300 shadow-sm focus:ring-yellow-500 focus:border-yellow-500 text-black">
                    ...
                    <button 
                        type="submit" 
                        class="w-full py-3 mt-6 flex justify-center items-center gap-2 text-white bg-yellow-600 hover:bg-yellow-700 rounded-lg shadow-lg font-semibold">
                        Submit
