...
class FAQs extends Component
{
    ...
    {
        $faqs = [
            ["question" => "What is AshenKeep?", "answer" => "AshenKeep is a vault application management system where the process of securing a vault in the Risen Christ Memorial Garden. From filling up an application form, and submitting requirements."],
            ...
            ["question" => "What documents are required for the application?", "answer" => "The required documents for the application include baptismal certificate and government id. These documents must be submitted online to verify eligibility for a columbarium vault."],
